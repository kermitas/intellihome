package as.logserver.rest;

import java.io.ByteArrayOutputStream;
import java.io.PrintStream;

public class AdminHtmlUtils
{
    // ==============================================
    ...
    public static void renderPageTopForAdmin( StringBuilder sb , String localization , String goBackDescription , String pathForBackButton )
    {
        sb.append( "<html>" );
            sb.append( "<body>" );        
                sb.append( "<h2><i>Welcome to " ).append( localization ).append( ".</i></h2>" );
       
                renderLinkToGoBackForAdmin( sb , goBackDescription , pathForBackButton );
    ...
    public static void renderPageBottomForAdmin( StringBuilder sb , String goBackDescription , String pathForBackButton )
    {            
                sb.append( "<hr />" );
    ...
    public static void renderLinkToGoBackForAdmin( StringBuilder sb , String goBackDescription , String pathForBackButton )
    { 
