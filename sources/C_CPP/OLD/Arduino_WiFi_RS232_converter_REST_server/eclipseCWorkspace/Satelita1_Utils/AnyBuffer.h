...
class AnyBuffer
{
	public:
		...
		SizeType put( DataType* data , SizeType sizeToPut ); // zwraca ile danych dodalo, moze byc mniej niz sizeToPut jesli remaining() byl mniejszy
...
template< typename DataType , typename SizeType >
bool AnyBuffer<DataType,SizeType>::put( DataType data )
{
	if( position >= limit )
	{
		// todo tu przydalby sie predzej exception!
...
/*
template< typename DataType , typename SizeType >
bool AnyBuffer<DataType,SizeType>::canPut( SizeType sizeToPut )
{
	return position + sizeToPut < limit;
}*/

// =================================================

template< typename DataType , typename SizeType >
SizeType AnyBuffer<DataType,SizeType>::put( DataType* data , SizeType sizeToPut )
{
	SizeType stp = min( sizeToPut , limit - position );

	/*if( position + sizeToPut >= limit )
	{
		// todo tu przydalby sie predzej exception!
	...
	{*/
		...
		memcpy( array+position , data , stp );
		position += stp;
...
{
	SizeType dataToSend = limit - position;
	stream->write( array+position , dataToSend );
	position = limit;
	return dataToSend;
